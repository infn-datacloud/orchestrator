...
@Component(WorkflowConstants.Delegate.CLEAN_FAILED_DEPLOY)
public class CleanFailedDeployment extends BaseDeployCommand {

  @Override
  protected String getErrorMessagePrefix() {
    return "Error cleaning failed Deployment creation";
  }
  ...
  public void execute(DelegateExecution execution, DeploymentMessage deploymentMessage) {
    ...
    getDeploymentProviderService(deploymentMessage).cleanFailedDeploy(deploymentMessage);
  }
